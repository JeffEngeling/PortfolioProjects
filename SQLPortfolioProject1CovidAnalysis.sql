...
-- Shows the percentage of cases resulting in death by different countries
...
-- Pulling data broken out by continent
...
-- Overall Global Totals start of pandemic to August 2023
...
-- Using a CTE to reflect % population vaccinated
...
-- Using a Temp Table to reflect % population vaccinated
